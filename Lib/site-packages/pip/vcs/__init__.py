...
class VersionControl(object):
    ...
    def compare_urls(self, url1, url2):
        """
        Compare two sku_repo URLs for identity, ignoring incidental differences.
        """
    ...
    def switch(self, dest, url, rev_options):
        """
        Switch the sku_repo at ``dest`` to point to ``URL``.
        """
        raise NotImplemented

    def update(self, dest, rev_options):
        """
        Update an already-existing sku_repo to the given ``rev_options``.
        """
        raise NotImplementedError
