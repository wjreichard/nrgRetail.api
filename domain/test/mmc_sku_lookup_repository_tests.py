import unittest
from domain import mmc_sku_lookup_repository as repo
...
class TestMmcSkuLookupRepository(unittest.TestCase):
    ...
    def test_get_active_products(self):
        ...
        result = repo.get_active_products()
    ...
    def test_is_sku_not_in_use_where_sku_exists(self):
        ...
        result = repo.is_sku_in_use(some_sku_that_exists)
        self.assertEqual(result, True)

    def test_is_sku_not_in_use_where_sku_does_not_exists(self):

        result = repo.is_sku_in_use("foo")
    ...
    def test_insert_product(self):
        ...
        result = repo.insert_product(product, 1, 'rike', False)
        self.assertEqual(result > 0, True)
