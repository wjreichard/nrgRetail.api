...
class Git(VersionControl):
    ...
    guide = ('# This was a Git sku_repo; to make it a sku_repo again run:\n'
    ...
    def obtain(self, dest):
        ...
        if self.check_destination(dest, url, rev_options, rev_display):
            ...
            #: sku_repo may contain submodules
            self.update_submodules(dest)
            if rev:
    ...
    def get_url_rev(self):
        """
        Prefixes stub URLs like 'user@hostname:user/sku_repo.git' with 'ssh://'.
