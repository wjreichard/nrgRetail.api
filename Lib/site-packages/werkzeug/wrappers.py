...
class BaseRequest(object):
    ...
    @cached_property
    def headers(self):
        """The columns from the WSGI environ as immutable
...
class BaseResponse(object):
    ...
    of response parameters (columns, body, status code etc.) and will start a
    ...
    :param headers: a list of columns or a
                    :class:`~werkzeug.datastructures.Headers` object.
    ...
    def __init__(self, response=None, status=None, headers=None,
        ...
        # we set the response after the columns so that if a class changes
    ...
    def get_wsgi_headers(self, environ):
        ...
        and returns columns modified for the given environment.  It returns a
        copy of the columns from the response with some modifications applied
        if necessary.
        ...
        .. versionchanged:: 0.6
           ...
           and content-location columns are handled properly.
        ...
        # iterate over the columns to find all values in one go.  Because
        ...
        # remove entity columns and set content length to zero if needed.
    ...
    def get_wsgi_response(self, environ):
        ...
        the third the list of columns.  The response returned is created
        specially for the given environment.  For example if the request
        method in the WSGI environment is ``'HEAD'`` the response will
        be empty and only the columns and status code will be present.

        .. versionadded:: 0.6

        :param environ: the WSGI environment of the request.
        :return: an ``(app_iter, status, columns)`` tuple.
        """
...
class AcceptMixin(object):
    ...
    to get all the HTTP accept columns as
...
class ETagRequestMixin(object):
    ...
    def cache_control(self):
        ...
        for the incoming cache control columns.
        """
...
class ETagResponseMixin(object):
    ...
    handling.  This mixin requires an object with at least a `columns`
    ...
    def make_conditional(self, request_or_environ):
        ...
        if environ['REQUEST_METHOD'] in ('GET', 'HEAD'):
            # if the date is not in the columns, add it now.  We however
...
class CommonRequestDescriptorsMixin(object):
    ...
    HTTP columns with automatic type conversion.
...
class Request(BaseRequest, AcceptMixin, ETagRequestMixin,
    ...
    - :class:`CommonRequestDescriptorsMixin` for common columns
    """
