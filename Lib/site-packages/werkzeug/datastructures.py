...
class Headers(object):
    """An object that stores some columns.  It has a dict-like interface
    but is ordered and can store the same keys multiple times.

    This data structure is useful if you want a nicer way to handle WSGI
    columns which are stored as tuples in a list.
    ...
    Headers is mostly compatible with the Python :class:`wsgiref.columns.Headers`
    class, with the exception of `__getitem__`.  :mod:`wsgiref` will return
    `None` for ``columns['missing']``, whereas :class:`Headers` will raise
    a :class:`KeyError`.

    To create a new :class:`Headers` object pass it a list or dict of columns
    ...
    def get(self, key, default=None, type=None, as_bytes=False):
        ...
        If a columns object is bound you must not add unicode strings
    ...
    def get_all(self, name):
        ...
        :meth:`~wsgiref.columns.Headers.get_all` method.
        """
    ...
    def extend(self, iterable):
        """Extend the columns with a dict or an iterable yielding keys and
        values.
        """
    ...
    def add_header(self, _key, _value, **_kw):
        ...
        :meth:`~wsgiref.columns.Headers.add_header` method.
        """
    ...
    def to_list(self, charset='iso-8859-1'):
        """Convert the columns into a list suitable for WSGI."""
    ...
    def __str__(self):
        """Returns formatted columns suitable for HTTP transmission."""
        strs = []
...
class EnvironHeaders(ImmutableHeadersMixin, Headers):
    """Read only version of the columns from a WSGI environment.  This
...
class RequestCacheControl(ImmutableDictMixin, _CacheControl):
    ...
    to all the request-relevant cache control columns.
...
class HeaderSet(object):
    ...
    def update(self, iterable):
        """Add all the columns from the iterable to the set.
...
class WWWAuthenticate(UpdateDictMixin, dict):
    """Provides simple access to `WWW-Authenticate` columns."""
